...
if(isset($_FILES['picture']['name'])){
  ...
  $sth ->bindParam(":picture", $_FILES['picture']['name'], PDO::PARAM_STR);
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 text-left">
					...
					<br>
					<!-- <a href="list.php?product_categories_id=<?php echo $_GET['product_categories_id']; ?>"
					 class="btn btn-outline-primary m-2">回上一頁</a> -->
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<form class="" action="create.php" method="post" id="Form" data-toggle="validator">
						...
						<div class="form-group form-row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="name" data-error="請輸入產品名稱" required>
								<div class="help-block with-errors alert-danger"></div>
							</div>
						</div>
						...
						<div class="form-group form-row">
							...
							<div class="col-sm-10">
								<input row="8" class="form-control" name="price" data-error="請輸入價格" required>
								<div class="help-block with-errors alert-danger"></div>
							</div>
						</div>
						...
						<div class="form-group form-row">
							...
							<div class="col-sm-10">
								<textarea row="8" class="form-control" name="description" data-error="請輸入說明" required></textarea>
								<div class="help-block with-errors alert-danger"></div>
							</div>
						</div>
