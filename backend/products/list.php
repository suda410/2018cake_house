				...
				<div class="col-md-12">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td>
									<img src="../../uploads/products/<?php echo $products['picture']; ?>" alt="" width="200" </td>
									<td>
									...
									<td>
										<a href="edit.php?product_categories_id=<?php echo $_GET['product_categories_id']; ?>&products_id=<?php echo $products['products_id'];?>"
										    class="btn btn-outline-primary">編輯</a>
										<a href="delete.php?product_categories_id=<?php echo $_GET['product_categories_id']; ?>&products_id=<?php echo $products['products_id'];?>"
										    class="btn btn-outline-primary" onclick="if(!confirm('確定刪除此筆資料?回復不能...')){return false;};">刪除</a>
									</td>
							</tr>
							<?php } ?>
						</tbody>
