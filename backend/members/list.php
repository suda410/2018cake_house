...
$query = $db->query("SELECT * FROM members ORDER BY members_id DESC LIMIT ".$start_from.",".$limit);
...
<body>
	...
	<div class="py-5 text-center">
		<div class="container">
			...
			<?php  if($total_rows > 0){
                    $sth = $db->query("SELECT * FROM members ORDER BY members_id DESC ");
