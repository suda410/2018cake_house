							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<a href="delete.php?news_id=<?php echo $news['news_id'];?>" class="btn btn-outline-primary" onclick="if(!confirm('確定刪除此筆資料?回復不能...')){return false;};">刪除</a>
									</td>
									<?php } ?>
								</tr>
								</tr>
