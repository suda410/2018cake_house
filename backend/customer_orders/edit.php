...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
  ...
  header('Location: list.php?customer_orders_id='.$_POST['customer_orders_id'].'&status='.$_POST['status']);
}else{
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-left">
          ...
          <a href="list.php?customer_orders_id=<?php echo $_GET['customer_orders_id']?>&status=<?php echo $_GET['status'];?>" class="btn btn-outline-primary m-2">回上一頁</a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
          <form class="" action="edit.php" method="post">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-sm-10">
                <textarea row="8" class="form-control" name="memo">
                  <?php echo $customer_orders['memo']; ?>
                </textarea>
              </div>
            </div>
            <div class="col-md-12 text-right">
              <a href="list.php?customer_orders_id=<?php echo $_GET['customer_orders_id']?>&status=<?php echo $_GET['status'];?>" class="btn btn-primary">取消並回上一頁</a>
