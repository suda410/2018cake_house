                ...
                <div class="container">
                    <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="product_list.php?category_id=<?php echo $product_categories['product_categories_id']; ?>">產品分類</a></li>  
                            <!-- <li><a href="javascript:history.back()">產品分類</a></li> -->
                            <li>產品</li>
                        </ul>
                    </div>
                    <div class="col-md-3">

                        <!-- *** MENUS AND FILTERS ***__ -->
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-pills nav-stacked category-menu">
                                    ...
                                    ?>
                                    <li>
                                        <a href="product_list.php?category_id=<?php echo $side_categories['product_categories_id']; ?>">
                                            <?php echo $side_categories['category']; ?>
                    ...
                    <div class="col-md-9">
                        <div class="row" id="productMain">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row" id="thumbs">
                                    <div class="col-xs-4">
                                        <a href="../images/apple.jpg" class="thumb">
                        ...
                        <div class="box" id="details">
                            <p>
                                ...
                                <blockquote>
                                    <p><em>麵包與蛋糕均為當天現做，收到商品後請盡早食用完畢。</em></p>
                                </blockquote>
                                <hr>
                                <div class="social">
