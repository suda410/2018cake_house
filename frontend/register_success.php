                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row" id="error-page">
                            <div class="col-sm-6 col-sm-offset-3">
                                <div class="box">
                                    <p class="text-center"><img src="../images/logo.png" alt="Cake House template"> </p>
                                    ...
                                    <?php }else{ ?>
                                    <h3>註冊失敗</h3>
                                    <h4 class="text-muted">請聯繫客服或前往這冊頁面重新註冊</h4>
                                    <p class="buttons">
                                        <a href="register.php" class="btn btn-primary"><i class="fa fa-home"></i>回首頁</a> </p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
