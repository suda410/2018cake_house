                            ...
                            <table class="table table-hover">
                                <thead>
									...
									<tr>
										...
										<th>
											<?php echo $customer['order_no'];?>
										</th>
										<td>
											<?php echo $customer['order_date'];?>
										</td>
										<td>
											<?php echo $customer['total_price'] + $customer['shipping']; ?>
										</td>
										<td>
										...
										<td>
											<a href="customer-order.php" class="btn btn-primary btn-sm">觀看詳細</a>
										</td>
