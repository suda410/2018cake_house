...
// 新品上市
$query2 = $db->query("SELECT * FROM products ORDER BY created_at DESC LIMIT 0,5");
...
//         $total_amount += $_SESSION['Cart'][$i]['quantity'];
//     }
// }
        ...
        <div id="top">
            <div class="container">
                <div class="col-md-6 offer" data-animate="fadeInDown">
                    <a href="frontend/register.php" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>
                    <span>&nbsp立即取得200元購物金!</span>
                </div>
                <div class="col-md-6" data-animate="fadeInDown">
                    <ul class="menu">
                        <?php if(isset($_SESSION['member']) && $_SESSION['member'] !=null) { ?>
                            <li><a href="frontend/customer-account.php">會員專區</a></li>
                            <li><a href="frontend/logout.php"><i class="fa fa-sign-out"></i> 登出</a></li>
                            <?php }else{ ?>
            ...
            <div class="container">
                    ...
                    <div class="navbar-buttons">
                        ...
                        <a class="btn btn-default navbar-toggle" href="basket.php">
                            ...
                            <span class="hidden-xs">
                                (<?php if(isset($_SESSION['Cart']) && $_SESSION['Cart'] != null) echo count($_SESSION['Cart']); else echo "0"; ?>)
                            </span>
                        </a>
                    </div>
                </div>
                ...
                <div class="navbar-collapse collapse" id="navigation">
                    <ul class="nav navbar-nav navbar-left">
                        ...
                        <li><a href="frontend/news_list.php">最新消息</a></li>
                ...
                <div class="navbar-buttons">
                    <div class="navbar-collapse collapse right" id="basket-overview">
                        <a href="frontend/basket.php" class="btn btn-primary navbar-btn">
                            <i class="fa fa-shopping-cart"></i>
                ...
                <div class="collapse clearfix" id="search">
                    ...
                    <form class="navbar-form" role="search" action="frontend/search_result.php" method="get">
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="請輸入關鍵字搜尋商品" name="keyword">
                        ...
                        <div class="same-height-row">
                            <div class="col-sm-4">
                                <div class="box same-height clickable">
                                    ...
                                    <h3><a href="#"><strong>我們熱愛並歡迎顧客</strong></a></h3>
                                    <p>眾所周知，我們提供最好的服務</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="box same-height clickable">
                                    ...
                                    <h3><a href="#"><strong>便宜近人</strong></a></h3>
                                    <p>高CP好吃不怕有負擔</p>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="box same-height clickable">
                                    ...
                                    <h3><a href="#"><strong>味道保證，不滿意退費</strong></a></h3>
                                    <p>請攜帶原包裝與剩下產品...</p>
                                </div>
                            </div>
                        </div>
 ...
 _________________________________________________________ -->
            ...
            <div class="new">
                <div class="box text-center" data-animate="fadeInUp">
                    <div class="container">
                        <div class="col-md-12">
                            <h2 class="text-uppercase">最新消息</h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12" data-animate="fadeInUp">
                        ...
                        <div class="col-sm-6">
                            <div class="post">
                                ...
                                <p class="read-more"><a href="frontend/news.php?id=<?php echo $news['news_id']; ?>" class="btn btn-primary">了解更多</a>
                                </p>
                            </div>
                        </div>
                    <?php } ?>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <a href="frontend/product_list.php?category_id=<?php echo $footer_categories['product_categories_id']; ?>">
                                <h5>
